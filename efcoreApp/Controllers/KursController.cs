...
namespace efcoreApp.Controllers
{
    public class KursController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            .FirstOrDefaultAsync(k => k.KursId == id);   // Include ile find async kullanılmıyor.
        ...
        public async Task<IActionResult> Edit(int id, KursViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!_context.Kurslar.Any(o => o.KursId == model.KursId))   // Any metodu ile ilgili öğrenciid nin veritabanında olup olmadığını kontrol ediyoruz
                    {
                        return NotFound();
                    }
                    else
